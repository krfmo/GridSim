 ...
 * RIPRouter.java - Simulates a network router with RIP as the advertising
 * protocol
 *
 */
package gridsim.net;
 ...
 */
public class RIPRouter extends Router
{
     ...
     * entity, please use {@link #RIPRouter(String, boolean)}.
     *
     * @param name Name of this router
     * @throws NullPointerException This happens when name is empty or null
     * @see #RIPRouter(String, boolean)
     * @pre name != null
     * @post $none
     */
    public RIPRouter(String name) throws NullPointerException {
        this(name, false);
    }
     ...
     * @post $none
     */
    public RIPRouter(String name, boolean trace) throws NullPointerException
    {
        super(name, trace);
        init();
    }
