...
/**
 * This class contains additional tags for the DataGrid functionalities,
...
public class DataGridTags
{
    ...
    public static final int PKT_SIZE = Link.DEFAULT_MTU * 100;  // in bytes
    ...
    /**
     * Denotes the submission of a DataGridlet. This tag is normally
     * used between user and DataGridResource entity.
     */
    public static final int DATAGRIDLET_SUBMIT = BASE + 6;
    ...
    /** Private Constructor */
    private DataGridTags() {
        throw new UnsupportedOperationException("DataGridTags cannot be instantiated");
    }
