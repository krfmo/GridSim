...
/**
 * About Submit - Pause - Resume - Finish
 */
class TestCase4 extends GridSim
{
    ...
    /**
     * Allocates a new TestCase4 object
     ...
     *          String)
     */
    TestCase4(String name, double bandwidth, double delay, int totalGridlet,
    ...
    public void body()
    {
        ...
        // PAUSING a Gridlet with an acknowledgement
        for (i = 0; i < list_.size(); i++)
        {
            if (i % 3 == 0)
            {
                success = super.gridletPause(i, myId_, resourceID[index],
                                             0.0, true);

                System.out.println(name_ + ": Pausing Gridlet #" + i +
        ...
        for (i = 0; i < list_.size(); i++)
        {
            if (i % 3 == 0)
            {
                success = super.gridletResume(i, myId_, resourceID[index],
                                              0.0, true);

                System.out.println(name_ + ": Resume Gridlet #" + i +
                    " at time = " + GridSim.clock() + " success = " + success);
            }
        }
        ...
        // Must cancel the previously paused Gridlets otherwise the program
        // will hang.
        for (i = 0; i < list_.size(); i++)
        {
            if ( (i % 3 == 0) || (i % 2 == 0) )
