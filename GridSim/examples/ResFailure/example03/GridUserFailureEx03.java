 ...
 */
public class GridUserFailureEx03 extends GridUser
{
     ...
     */
    public GridUserFailureEx03(String name, Link link, double pollTime,
            ...
            else if (gl.getGridletStatusString().compareTo("Failed") == 0)
            {
                ...
                else
                {
                    ...
                    super.send(super.get_id(), GridSimTags.SCHEDULE_NOW,
                               GridUserFailureEx03.SUBMIT_GRIDLET, glID_Int);
                }
