 ...
 * included in the parallel directory (e.g. sdsc_blue_01.txt).
 * 
 * For example, in order to run the example on Linux, you should use:
 *	
 * java -cp $GRIDSIM/jars/gridsim.jar;. parallel.agressive.ExampleEASY01 \
 *    			$GRIDSIM/examples/parallel/sdsc_blue_01.txt
 */

package parallel.agressive;
