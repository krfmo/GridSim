 ...
 * Date: May 2009
 * 
 * Description: This example shows how to create a resource using a conservative 
 ...
 *	
 * java -cp $GRIDSIM/jars/gridsim.jar;. parallel.conservative.ExampleCB01 \
 *    			$GRIDSIM/examples/parallel/sdsc_blue_01.txt
 */

package parallel.conservative;
...
public class ExampleCB01
{
    ...
    private static GridResource createGridResource(String name, int peRating,
        ...
        try {
        	ConservativeBackfill policy = new ConservativeBackfill(name, "Conservative");
