...
/**
 * This is an example that demonstrates how to implement basic user behviour.
 * The topology and the resources are the same as in other datagrid examples.
 * The user behaviour is implemented in Fileuser.java.
 *
...
public class DataExample2 {
    public static void main(String[] args) {
        ...
        // Create user(s)
        try {
            user = new FileUser("File_User", baud_rate, propDelay, mtu);
        ...
        try {
            ...
            for (i = 0; i < resList.size(); i++) {
                ...
                r2.attachHost(resObj, resSched);// attach resource to router
            }
            // connect user
    ...
    private static DataGridResource createGridResource(String name,
        ...
        try {
            ...
            File f = new File("testFile1", 1);// 100 MB
            gridRes.addFile(f);
